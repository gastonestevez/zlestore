      ...
      <div class="uk-card-header">
          <div class="uk-grid-small uk-flex-middle" uk-grid>
              <div class="uk-width-expand">
                  <div class="uk-card-badge uk-label" style="background: purple;">Employee</div>
                  <h3 class="uk-card-title uk-margin-remove-bottom">Alan</h3>
                  <p class="uk-text-meta uk-margin-remove-top"><time datetime="2016-04-01T19:00">tato@dakota.com</time></p>
              </div>
          </div>
      </div>
      <div class="uk-card-footer uk-flex uk-flex-between">
          <a href="#" class="uk-button uk-button-text">Editar</a>
